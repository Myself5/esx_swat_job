Locales['en'] = {
  ...
  -- Elevator
  ['elevator'] = 'elevator',
  ['elevator_maze_roof'] = 'go to the Helicopter Pad',
  ...
  ['helicopter_prompt'] = 'Press ~INPUT_CONTEXT~ to access ~y~Helicopter Actions~s~.',
  ['shop_item'] = '$%s',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by a ~b~SWAT Unit~s~',
  -- Vehicle interaction
  ...
  ['got_confiscated'] = '~y~%sx~s~ ~b~%s~s~ were confiscated by a ~y~SWAT Unit~s~',
  ['you_confiscated_account'] = 'you confiscated ~g~$%s~s~ (%s) from ~b~%s~s~',
  ['got_confiscated_account'] = '~g~$%s~s~ (%s) was confiscated by a ~y~SWAT Unit~s~',
  ['you_confiscated_weapon'] = 'you confiscated ~b~%s~s~ from ~b~%s~s~ with ~o~%s~s~ bullets',
  ['got_confiscated_weapon'] = 'your ~b~%s~s~ with ~o~%s~s~ bullets was confiscated by a ~y~SWAT Unit~s~',
